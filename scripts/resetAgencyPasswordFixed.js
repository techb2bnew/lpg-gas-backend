...
if (!email) {
  console.log('❌ Usage: node resetAgencyPasswordFixed.js <email> [newPassword]');
  console.log('💡 Example: node resetAgencyPasswordFixed.js ankit@yopmail.com');
  console.log('💡 Example: node resetAgencyPasswordFixed.js ankit@yopmail.com mynewpassword');
  process.exit(1);
}
